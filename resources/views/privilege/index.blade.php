...
@section('content')
					<div class="panel panel-default">
                        <div class="panel-heading">
                                <h3 class="panel-title"><strong>View Privileges</strong> Layout</h3>
                        ...
                        <div class="panel-body">
                        	<div class="pull-right">
                                        <a href="{{ url('/privilege_insert')}}" class="btn btn-success"><i class="fa fa-plus"></i> Create New</a>
                        	...
                        	<div class="panel-body">
                                    <table id="customers" class="table datatable">
                                        ...
                                        <tbody>
                                            @foreach($Tprivileges as $privilege) 
                                            <tr>
                                                <td>{{ $privilege->id }}</td>
