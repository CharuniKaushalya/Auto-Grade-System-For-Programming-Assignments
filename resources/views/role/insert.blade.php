                     ...
                     {!! csrf_field() !!}
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>Add Role</strong> Layout</h3>
                            ...
                            <div class="panel-body">                                                                        
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-12">                                            
                                        <div class="input-group">
                                            ...
                                            @endif                                          
                                        <span class="help-block">Add role title field (Eg: add user)</span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-12">                                            
                                        ...
                                        <span class="help-block">description field for role</span>
                                    </div>
                                </div>
